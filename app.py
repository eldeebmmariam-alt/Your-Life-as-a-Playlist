...
PERSONA_DETAILS = {
    "the-life-of-the-party": {
        ...
        "recs": [
            ...
            {"title": "Temperature", "artist": "Sean Paul", "why": "Criminally underrated. Still hits harder than most things released this decade."},
        ],
    },
    "the-main-character": {
    ...
    "the-global-ear": {
        ...
        "recs": [
            ...
            {"title": "Padam Padam", "artist": "Edith Piaf", "why": "The original viral song — decades before the algorithm existed."},
        ],
    },
    "the-romantic": {
        "name": "The Romantic",
    ...
    "the-hype-beast": {
        ...
        "recs": [
            ...
            {"title": "New Magic Wand", "artist": "Tyler, The Creator", "why": "The track that proves Tyler operates on a completely different level."},
        ],
    },
    "the-overthinker": {
    ...
    "the-trendsetter": {
        ...
        "recs": [
            {"title": "Boy's a liar Pt. 2", "artist": "PinkPantheress ft. Ice Spice", "why": "You heard this before anyone you know. Admit it."},
            {"title": "Vroom Vroom", "artist": "Charli XCX", "why": "The song that told us where pop was going — back in 2016."},
...
GENRE_TO_PERSONA = {
    ...
    "Folk/Indie": "the-global-ear",
    "World": "the-global-ear",
    "Reggae": "the-global-ear",
    "Latin": "the-global-ear",
    "Shoegaze": "the-overthinker",
    "Ambient": "the-chill-soul",
...
QUIZ_QUESTIONS = [
    ...
    },
    {
        ...
        "options": [
            ("💥 Turn it up immediately. This is the song of all time.", "the-hype-beast", "the-life-of-the-party"),
            ("😭 Feel something you haven't felt in years. You just sit with it.", "the-nostalgist", "the-romantic"),
    ...
    },
    {
        ...
        "options": [
            ...
            ("😩 Ten minutes of deliberating. The opening track sets the entire tone.", "the-overthinker", "the-daydreamer"),
            ("😤 Play exactly what I want. They'll thank me in five minutes.", "the-rebel", "the-hype-beast"),
            ("🤝 Quick read of the room first — then I build from what people need.", "the-chill-soul", "the-global-ear"),
        ]
    },
    {
    ...
    },
    {
        ...
        "options": [
            ("🙌 An entire crowd screaming the same lyrics — you're one of them.", "the-life-of-the-party", "the-hype-beast"),
            ("💭 A song puts words to something you felt but could never describe.", "the-overthinker", "the-romantic"),
            ("🌍 A track in a language you don't speak — and you feel every single word.", "the-global-ear", "the-daydreamer"),
            ("⏳ Finding a 40-year-old record that sounds like it was made for you.", "the-old-soul", "the-nostalgist"),
        ]
    },
    {
...
def render_persona_animation(persona_id):
    ...
    st.markdown(
        '<div id="' + uid + '_layer" style="position:fixed;inset:0;width:100vw;'
        'height:100vh;pointer-events:none;overflow:hidden;z-index:999;">'
        + items_html + '</div>',
...
@keyframes spiritFloat{0%{transform:translateY(0);opacity:0}10%{opacity:0.35}100%{transform:translateY(-115vh);opacity:0}}
...
with st.expander("📸 Download your result card"):
    ...
    for rec in persona.recs:
        st.markdown(
            ...
            'border-left:3px solid ' + persona.color + ';border-radius:12px;'
